...
PKG_NAME="hi3796m-drivers"
PKG_VERSION="spc057"
PKG_REV="1"
PKG_ARCH="any"
PKG_LICENSE="nonfree"
PKG_SITE="http://www.hisilicon.com"
PKG_URL="http://shivanet.ro/tmp/$PKG_NAME-$PKG_VERSION.tar.xz"
PKG_DEPENDS_TARGET="toolchain"
PKG_PRIORITY="optional"
PKG_SECTION="graphics"
PKG_SHORTDESC="hi3796m-drivers: OpenGL-ES driver for Hi3796M"
PKG_LONGDESC="hi3796m-drivers: OpenGL-ES driver for Hi3796M"
...
pre_build_target() {
  ...
  cp $PKG_DIR/load $PKG_DIR/unload $PKG_BUILD/
} 
...
make_target() {
  mkdir -p $SYSROOT_PREFIX/usr/include
    ...
    cp -PRv include/OMX* $SYSROOT_PREFIX/usr/include
  ...
  mkdir -p $SYSROOT_PREFIX/usr/lib
    ...
    cp -PRv lib/share/libOMX* $SYSROOT_PREFIX/usr/lib
...
makeinstall_target() {
  ...
  cp load unload $INSTALL/lib/modules/$(get_module_dir)/$PKG_NAME
  mkdir -p $INSTALL/etc
  echo "$INSTALL"
  pwd
  ls -1 *
  cp -PRv etc/* $INSTALL/etc
  mkdir -p $INSTALL/usr/lib
    ...
    cp -PRv lib/extern/libformat_open.so $INSTALL/usr/lib
...
#    cp -PRv lib/extern/libbluray.so.1 $INSTALL/usr/lib
    ...
    cp -PRv lib/share/libOMX* $INSTALL/usr/lib
